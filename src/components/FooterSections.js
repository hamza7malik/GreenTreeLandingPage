      ...
      <div className="bottomfooter py-5 d-flex align-items-center justify-content-between">
        <div className="left">
          <div className="footerlogo">
            <a href="https://wisoftsolutions.com/">
              <img
                className="lazyload"
        ...
        <div className="copyright ms-3">
          <p className="m-0">
            Copyright 2023 <span> Wisoft Solutions</span>. All Rights Reserved
          </p>
        </div>
        <div className="right">
          <span>Follow Us :</span>
          <ul className="social_follow">
            <li>
              <a href="https://www.facebook.com/wisoftsolutions/">
                <svg
            ...
            <li>
              <a href="https://twitter.com/Wisoftsolutions">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={30}
                  height={30}
            ...
            <li>
              <a href="https://ae.linkedin.com/company/wisoftsolutions">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={30}
                  height={30}
            ...
            <li>
              <a href="https://www.youtube.com/channel/UCHc4sypQWl2HQx5jHm9GjHg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={30}
                  height={30}
