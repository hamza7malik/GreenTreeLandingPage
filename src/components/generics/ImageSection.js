...
export const ImageSection = () => {
  return (
    <div className="cryptoWallet d-block pb-lg-3 pt-2">
    <div className="title pt-2 pt-md-3">
    ...
    <div className="container">
      <div className="row align-items-center justify-content-center">
        <div className="col-lg-7 col-md-5 col-12">
          <div className="cryptoWalletBox">
            <div className="mb-4 mb-lg-0 text-center p-0 p-md-3">
              <img src="./images/web-hosting.webp" />
            </div>
          </div>
        </div>
